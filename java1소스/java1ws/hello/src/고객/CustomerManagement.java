package day12.상속_inheritance.고객;

public class CustomerManagement {
    public static void main(String[] args) {
        // 일반 고객 생성
        Customer customer1 = new Customer("송병화", "song@example.com", "010-1234-5678");

        // VIP 고객 생성
        VIPCustomer vipCustomer1 = new VIPCustomer("백바울", "back@example.com", "010-5678-1234", 15.0);

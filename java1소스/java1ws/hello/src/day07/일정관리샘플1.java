...
public class 일정관리샘플1 {
    ...
    public static void main(String[] args) {
        String[][] schedule = new String[31][5]; // 31일, 각 날짜에 최대 5개의 일정
        int[] dayIndex = new int[31]; // 각 날짜별 일정 개수를 추적하는 배열
        Scanner sc = new Scanner(System.in);
        int menu;

        loop: while (true) {
            System.out.println("3월 일정 관리 프로그램");
            ...
            switch (menu) {
                case 1:
                    ...
                    schedule[insertDate][dayIndex[insertDate]] = insertDay;
                    dayIndex[insertDate]++;
                    break;
                ...
                case 2:
                    ...
                    for (int i = 0; i < dayIndex[selectDate]; i++) {
                        System.out.println((i + 1) + ". " + schedule[selectDate][i]);
                    }
                    break;
                ...
                case 3:
                    ...
                    schedule[updateDate][updateIndex] = updateDay;
                    break;
                ...
                case 4:
                    ...
                    for (int i = 0; i < dayIndex[deleteDate]; i++) {
                        System.out.println((i + 1) + ". " + schedule[deleteDate][i]);
                    }
                    ...
                    for (int i = deleteIndex; i < dayIndex[deleteDate] - 1; i++) {
                    	schedule[deleteDate][i] = schedule[deleteDate][i + 1];
                    }
                    schedule[deleteDate][dayIndex[deleteDate] - 1] = ""; // 마지막 요소 비우기
                    dayIndex[deleteDate]--;
                    break;

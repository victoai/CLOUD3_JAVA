...
public class GameMain {
	...
	static Monster[] monsters = { new Monster("고블린", 300, 10, 20), new Monster("오크", 700, 15, 30),
			new Monster("늑대", 500, 12, 25), new Monster("드래곤", 1500, 25, 100), new Monster("해골 병사", 400, 14, 35),
			new Monster("트롤", 900, 18, 50), new Monster("슬라임", 200, 8, 15), new Monster("뱀파이어", 800, 20, 60),
			new Monster("미노타우로스", 1200, 22, 80), new Monster("데몬로드", 2000, 30, 150) };
